...
CREATE OR REPLACE PROCEDURE add_return_rec(p_return_id VARCHAR(10), p_issued_id VARCHAR(10), p_book_quality VARCHAR(15))
LANGUAGE plpgsql
AS $$

DECLARE
v_isbn VARCHAR(50); ---To store the ISBN of the returned book
v_book_name VARCHAR(80);---To store the book’s name
